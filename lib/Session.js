...
Session.prototype.preferredBitrate = function preferredBitrate (bitRate) {
    b.session_preferred_bitrate(this._sp_session, bitRate);
};

Session.prototype.preferredOfflineBitrate = function preferredOfflineBitrate (bitRate, allowResync) {
    b.session_preferred_offline_bitrate(this._sp_session, bitRate, allowResync);
};

Session.prototype.privateSession = function privateSession (isPrivate) {
    return b.session_private_session(this._sp_session, isPrivate);
};
